...
ALLOWED_HOSTS = ['.herokuapp.com', '127.0.0.1', 'localhost', 'my-boutique-ado-project-ci-ab80be493c34.herokuapp.com/']
...
ACCOUNT_SIGNUP_EMAIL_ENTER_TWICE = True  # Require user to enter email twice during signup
